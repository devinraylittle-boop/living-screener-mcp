...
```text
2026.06.11-alert-candidate-clarity
```
...
GET /health/full?expected_build_version=2026.06.11-alert-candidate-clarity
...
GET /debug/scan-schema?expected_build_version=2026.06.11-alert-candidate-clarity
GET /crypto/rules
...
It polls `/version` every 30 seconds. When `2026.06.11-alert-candidate-clarity` appears, it automatically runs `validate_live.ps1`.
