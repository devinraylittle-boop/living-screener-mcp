    ...
    def _session_risk_guard_schema_preview(self) -> dict[str, Any]:
        return {
            ...
            "rules": [
                ...
                "No hard daily trade-count cap for review/paper research.",
                "Block new manual/cash escalation after 3 closed losses in the current trading day.",
                "No market orders.",
                "No broker action from this MCP.",
            ],
