...
2. If callable, call get_version and confirm build_version is 2026.06.11-journal-vault.
...
- /version
- /health/full?expected_build_version=2026.06.11-journal-vault
- /debug/tool-manifest
- /debug/scan-schema?expected_build_version=2026.06.11-journal-vault
