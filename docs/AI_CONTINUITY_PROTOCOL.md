...
- Expected build: `2026.06.10-failure-mode-audit`
...
2. Call `get_version`.
3. Confirm build is `2026.06.10-failure-mode-audit`.
...
- `/version`
- `/health/full?expected_build_version=2026.06.10-failure-mode-audit`
- `/debug/tool-manifest`
- `/debug/scan-schema?expected_build_version=2026.06.10-failure-mode-audit`
