...
- Expected build: `2026.06.11-data-truth-cockpit`
...
2. Call `get_version`.
3. Confirm build is `2026.06.11-data-truth-cockpit`.
...
- `/version`
- `/health/full?expected_build_version=2026.06.11-data-truth-cockpit`
- `/debug/tool-manifest`
- `/debug/scan-schema?expected_build_version=2026.06.11-data-truth-cockpit`
