...
- Expected build: `2026.06.11-paper-exploration`
...
2. Call `get_version`.
3. Confirm build is `2026.06.11-paper-exploration`.
...
- `/debug/tool-manifest`
- `/debug/scan-schema?expected_build_version=2026.06.11-paper-exploration`
