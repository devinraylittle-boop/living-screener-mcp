...
- Expected build: `2026.06.11-broker-proof-bridge`
...
2. Call `get_version`.
3. Confirm build is `2026.06.11-broker-proof-bridge`.
...
- `/debug/tool-manifest`
- `/debug/scan-schema?expected_build_version=2026.06.11-broker-proof-bridge`
